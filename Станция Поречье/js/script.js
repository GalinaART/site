...
function marginOfPageBlocks() {
	...
	pageBlocks[2].style.marginBottom = margBottom / 2 + "px";
	pageBlocks[3].style.marginBottom = margBottom * 2.666 + "px";
}
...
doAndAddEventListener("resize", function() {
	// 3 : 4 647
	frontViewImage.style.height = `${parseFloat(getComputedStyle(frontViewImage).width) * 0.6739583333333333}px`;
});
